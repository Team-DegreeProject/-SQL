...
//小情况；小条�?
  final public ArrayList<Object> condition() throws ParseException {
    Token t;
  ...
  final public void name(List<Object> tl) throws ParseException {
    Token t;
    List<Object> templist = tl;
    t = jj_consume_token(ID);
    saveTokenInList(t,templist);
  }

//�?单条�?
  final public void simpleCondition(List<Object> tl) throws ParseException {
 Token t;
List<Object> templist = tl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case EQ:
    ...
    rightCondition(templist);
  }

  final public void rightCondition(List<Object> tl) throws ParseException {
 Token t;
List<Object> templist = tl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case STRING:
...
//功能方法
  final public void function(List<Object> tl) throws ParseException {
 Token t;
List<Object> templist = tl;
    //  id (（多）参�? )
         t = jj_consume_token(ID);
 ...
 Token t;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1010000,0x1010000,0x0,0x0,0x0,0x0,0x400000,0x0,0x807800,0x400000,0x0,0x300000,0x300000,0x2000000,0x80000000,0x80000000,0x2000000,0x78000000,0x78000000,0x0,0x2000000,0x0,0x0,0x0,0x0,0x0,0x8000,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x800,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10000000,0x1,0x1,0x10000000,0x6,0x2,0x30000000,0x0,0x800,0x10000000,0x20000000,0x800,0x2000,0x0,0x800,0x10000000,0x800,0x20000000,0x800,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x6,0x0,0x6,0x6,0x0,0x6,0x0,0x0,0x6,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,};
   }
